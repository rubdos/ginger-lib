...
mod test {
    ...
    fn test_poseidon_hash_mnt4() {
        use crate::crh::poseidon::parameters::mnt4753::{
            MNT4753PoseidonParameters, MNT4InversePoseidonSBox, MNT4PoseidonHash,
        };
        use algebra::{biginteger::BigInteger768, fields::mnt4753::Fr as MNT4753Fr};
    ...
    fn test_poseidon_hash_mnt6() {
        use crate::crh::poseidon::parameters::mnt6753::{
            MNT6753PoseidonParameters, MNT6InversePoseidonSBox, MNT6PoseidonHash,
        };
        use algebra::{biginteger::BigInteger768, fields::mnt6753::Fr as MNT6753Fr};

        // Test vectors are computed via the script in ./parameters/scripts/permutation_mnt6fr.sage
        let start_states = vec![
            vec![MNT6753Fr::zero(); 3],
            vec![
                MNT6753Fr::new(BigInteger768([
                    0x2045f548c283a386,
                    0x9f90d7b623ef9965,
                    0x634e1e0bcd6ce5f1,
                    0xed09fb1cd92e2f48,
    ...
    fn test_poseidon_hash_bn382_fr() {
        ...
        use algebra::{biginteger::BigInteger384, fields::bn_382::Fr as BN382Fr};

        // Test vectors are computed via the script in ./parameters/scripts/permutation_bn382.sage
        let start_states = vec![
            vec![BN382Fr::zero(); 3],
            vec![
                BN382Fr::new(BigInteger384([
                    0x3c2fc28fee546f2f,
                    0x46673e3f762a05a9,
                    0xf3a4196fb7f077b0,
                    0xea452bd940906dd0,
    ...
    fn test_poseidon_hash_bn382_fq() {
        ...
        use algebra::{biginteger::BigInteger384, fields::bn_382::Fq as BN382Fq};

        // Test vectors are computed via the script in ./parameters/scripts/permutation_bn382dual.sage
        let start_states = vec![
            vec![BN382Fq::zero(); 3],
            vec![
                BN382Fq::new(BigInteger384([
                    0x239d004c236ddb,
                    0x88d83e760e8bd5bb,
                    0x2ca0f68190713e45,
                    0x8f6a964f924c8fff,
