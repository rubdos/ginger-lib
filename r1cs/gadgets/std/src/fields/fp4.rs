use algebra::{fields::{
    ...
    Field, Fp2Parameters,
}, PrimeField, Fp2, SquareRootField, Fp2ParamsWrapper};
use r1cs_core::{ConstraintSystemAbstract, SynthesisError};

use crate::{
    prelude::*, fields::fp2::Fp2Gadget,
};

impl<P, ConstraintF: PrimeField + SquareRootField> QuadExtParametersGadget<ConstraintF> for Fp4ParamsWrapper<P>
    where
        P: Fp4Parameters,
        P::Fp2Params: Fp2Parameters<Fp = ConstraintF>,
{
    ...
    fn mul_base_field_gadget_by_nonresidue<CS: ConstraintSystemAbstract<ConstraintF>>(
        ...
        let new_c0 = Fp2ParamsWrapper::<P::Fp2Params>::mul_base_field_gadget_by_nonresidue(cs, &fe.c1)?;
    ...
    ) -> Result<QuadExtFieldGadget<Self, ConstraintF>, SynthesisError>
    {
        ...
        let c1_squared_nr = Self::mul_base_field_gadget_by_nonresidue(cs.ns(||"nr * c1^2"), &c1_squared)?;
        ...
        P::Fp2Params: Fp2Parameters<Fp = ConstraintF>,
{
    ...
    pub fn mul_by_023<CS: ConstraintSystemAbstract<ConstraintF>>(
        &self,
        mut cs: CS,
        other: &Self,
        ...
        let c0 = {
            let non_residue_times_v1 =
                Fp4ParamsWrapper::<P>::mul_base_field_gadget_by_nonresidue(cs.ns(|| "v1 mul_by_nr"), &v1)?;
